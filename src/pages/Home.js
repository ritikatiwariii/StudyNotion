...
function Home() {
  return <div>
    {/* section1 */}
    <div className="flex relative flex flex-col w-11/12 items-center text-white justify-between max-w-maxContent mx-auto">

      <Link to={"/signup"}>
        <div className=" group mt-16 p-1 mx-auto rounded-full bg-richblack-800 font-bold text-richblack-200 transition-all duration-200 hover:scale-95 w-fit ">
          <div className="flex items-center gap-2 flex-row rounded-full px-10 py-[5px] group-hover:bg-richblack-900">
      ...
      <div className="w-[90%] text-center text-richblack-300 mt-7 text-lg font-bold ">
    ...
    <div className="bg-pure-greys-5 text-richblack-700">
      <div className="homepage_bg h-[333px]">
       ...
       <div className="flex flex-row gap-7 text-white">
        ...
        <div className="flex items-center gap-2">Learn More
        <FaArrowRight />
        </div>  
        </CTAButton>
       </div>
      ...
      <div className="flex flex-row gap-5 mt-10 mb-12">
        <div className="text-4xl font-semibold w-[50%]">
        Get the Skills You need for a<HighlightText text={"Job that is in demand"} />
        </div>
        <div className="flex flex-col gap-7 w-[50%] items-start">
